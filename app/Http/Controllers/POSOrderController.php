  ...
  public function store(Request $request)
{
    ...
    try {
        ...
        $usedGoldAutoAmount = $request->used_gold_auto_amount;
        $usedGoldManualAmount = $request->used_gold_manual_amount;
        $usedGoldAmount = $usedGoldAutoAmount + $usedGoldManualAmount;
        ...
        $isCreditInvoice = $request->balance > 0 ? 1 : 0 ;
    ...
    private function processGoldAdvanceUsage($customer, $posOrder, $usedGoldGrams, $usedGoldAmount, $usedGoldRate, $usedGoldRateId, $goldAdvanceOrderNo)
    {
        ...
        if ($goldAdvanceOrderNo) {
            ...
            if ($specificGoldAdvance) {
                ...
                $specificGoldAdvance->decrement('gold_balance', $usedGoldGrams);
            }
        } else {
            ...
            foreach ($generalGoldAdvances as $goldAdvance) {
                ...
                $goldAdvance->decrement('gold_balance', $usedGoldGrams);
            }
        }
    }

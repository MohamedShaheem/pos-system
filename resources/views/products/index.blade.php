...
@section('content')
            ...
            <div class="card" >
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('products.disable.show') }}" class="btn btn-danger">Disabled Product List</a>
                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button class="btn btn-danger btn-sm" 
                                                    onclick="disableProduct({{ $product->id }}, '{{ $product->product_no }}')">
    ...
    <script>
    function disableProduct(productId, productNo) {
        Swal.fire({
            title: 'Are you sure?',
            html: `You are about to disable product <strong>${productNo}</strong>!`,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                window.location.href = `/products/disable/${productId}`;
            }
        });
    }
    </script>

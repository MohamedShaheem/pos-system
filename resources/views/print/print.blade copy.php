...
<div class="invoice-container">
    ...
    <div style="display: flex; justify-content: space-between;">
        <div class="header-info">
            ...
            <div><strong>Address:</strong> {{ $posOrder->customer->address }}</div>
    ...
    <table class="invoice-table">
        ...
        @foreach($posOrder->orderDetails as $detail)
            <tr>
                ...
                <td class="rs-col">{{ number_format($detail->amount, 2) }}</td>
                @endif
            </tr>
        @endforeach
        ...
        @php
            ...
            $subtotalWeight = $adjustedNetWeight - $totalWastageWeight;

            // Subtotal before cash advance deduction
            $subtotalAmount = $totalProductAmount - $goldAdvanceAmount;

            // Amount after cash advance deduction
            $afterAdvancesAmount = $subtotalAmount - $cashAdvanceUsed - $totalExchangeGoldAmount;
        @endphp
        ...
        <!-- Final Subtotal after all advances and exchange calculated -->
        <tr class="subtotal-row">
            <td class="description-col"></td>
            <td></td>
            <td></td>
